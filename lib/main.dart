...
var darkColorScheme = ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 5, 59, 125), brightness: Brightness.dark);
    ...
    MaterialApp(
      ...
      theme: ThemeData().copyWith(
        ...
        appBarTheme: const AppBarTheme().copyWith(
          backgroundColor: colorSchema.onPrimaryContainer,
